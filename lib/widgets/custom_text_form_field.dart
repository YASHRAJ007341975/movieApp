...
extension TextFormFieldStyleHelper on CustomTextFormField {
  static OutlineInputBorder get outlineDeepOrangeA => OutlineInputBorder(
        borderRadius: BorderRadius.circular(25.h),
        borderSide: BorderSide(
  ...
  static OutlineInputBorder get outlineRedTL25 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(25.h),
        borderSide: BorderSide(
  ...
  static OutlineInputBorder get outlineRedATL15 => OutlineInputBorder(
